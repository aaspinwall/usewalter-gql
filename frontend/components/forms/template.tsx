                    ...
                    <Form>
                        <div id="top-form">
                            <div>
                                ...
                                <Field type="text" name="first" placeholder={content.placeholders.first}></Field>
                                <ErrorMessage name="first" component="span" />
                            </div>

                            <div>
                                <label htmlFor="last">Last Name</label>
                                <Field type="text" name="last" placeholder={content.placeholders.last} />
                                <ErrorMessage name="last" component="span" />
                            </div>
                        </div>

                        <label htmlFor="email">Email Address</label>
                        <Field type="text" name="email" placeholder={content.placeholders.email} />
                        <ErrorMessage name="email" component="span" />

                        <label htmlFor="company">Company</label>
                        <Field type="text" name="company" placeholder={content.placeholders.company} />
                        <ErrorMessage name="company" component="span" />

                        <label htmlFor="code">Code</label>
                        <Field type="text" name="promoCode" placeholder={content.placeholders.promoCode} />
